...
START_TEST(test_BIT_FIELD_other) {
  ...
  ck_assert_ptr_eq(terminals[1].value, nullptr);
  ck_assert_uint_eq(terminals[1].lineno, 0);
  ck_assert_uint_eq(terminals[1].column, lenof("[...]"));
  ck_assert_uint_eq(terminals[1].length, 0);
  STDAllocator.free((void *) terminals);
  ck_assert_uint_eq(lineno, 0);
  ck_assert_uint_eq(column, lenof("[...]"));
}
END_TEST
...
START_TEST(test_WIDTH_bit) {
  ...
  ck_assert_ptr_eq(terminals[1].value, nullptr);
  ck_assert_uint_eq(terminals[1].lineno, 0);
  ck_assert_uint_eq(terminals[1].column, lenof("[23-bit]"));
  ck_assert_uint_eq(terminals[1].length, 0);
  STDAllocator.free((void *) terminals);
  ck_assert_uint_eq(lineno, 0);
  ck_assert_uint_eq(column, lenof("[23-bit]"));
}
END_TEST
...
START_TEST(test_WIDTH_default_bit) {
  ...
  ck_assert_ptr_eq(terminals[1].value, nullptr);
  ck_assert_uint_eq(terminals[1].lineno, 0);
  ck_assert_uint_eq(terminals[1].column, lenof("[23]"));
  ck_assert_uint_eq(terminals[1].length, 0);
  STDAllocator.free((void *) terminals);
  ck_assert_uint_eq(lineno, 0);
  ck_assert_uint_eq(column, lenof("[23]"));
}
END_TEST
...
START_TEST(test_WIDTH_byte) {
  ...
  ck_assert_ptr_eq(terminals[1].value, nullptr);
  ck_assert_uint_eq(terminals[1].lineno, 0);
  ck_assert_uint_eq(terminals[1].column, lenof("[46-byte]"));
  ck_assert_uint_eq(terminals[1].length, 0);
  STDAllocator.free((void *) terminals);
  ck_assert_uint_eq(lineno, 0);
  ck_assert_uint_eq(column, lenof("[46-byte]"));
}
END_TEST
...
START_TEST(test_TIME_TICK) {
  ...
  ck_assert_ptr_eq(terminals[1].value, nullptr);
  ck_assert_uint_eq(terminals[1].lineno, 0);
  ck_assert_uint_eq(terminals[1].column, lenof("(4-tick)"));
  ck_assert_uint_eq(terminals[1].length, 0);
  STDAllocator.free((void *) terminals);
  ck_assert_uint_eq(lineno, 0);
  ck_assert_uint_eq(column, lenof("(4-tick)"));
}
END_TEST
